...
1. Install [RTX Remix](https://github.com/NVIDIAGameWorks/rtx-remix) into the game folder. It is recommended to use [RTX Remix](https://github.com/RemixProjGroup/dxvk-remix/)
